function dat = impDat3(filename, startRow, endRow)
...
%
% Example:
%   dat = importfile('test.dat', 2, 8129);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/06/23 23:22:15
...
formatSpec = '%{yyyy/MM/dd HH:mm:ss}D%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%[^\n\r]';
